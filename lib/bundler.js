...
export const runBundler = async (inputPath, outputPath, staticDir) => {
    try {
        // Determine the Node built-in modules so Esbuild NEVER attempts to bundle them
        // This solves the React Native and Native Node.js webcontainer crash issues
        const externalModules = builtinModules.builtinModules || [];
